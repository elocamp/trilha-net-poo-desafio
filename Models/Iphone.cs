namespace DesafioPOO.Models {
    public class Iphone : Smartphone {
        public Iphone(string numeroInicial, string modeloInicial, string imeiInicial, int memoriaInicial) : base(numeroInicial, modeloInicial, imeiInicial, memoriaInicial) {
